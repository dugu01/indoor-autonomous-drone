# Package Manifest — Stage S2.2 v0.5.3.3 Multi-Seed Robustness Candidate
...
## v0.5.3.3 correction utilities

- `audit_S2_2_v0_5_3_3.py` — cumulative source/package audit.
- `s2_2_v0_5_3_3_xy_loss_regression.py` — focused blind-mode braking regression.
- `CORRECTION_NOTES_S2_2_V0_5_3_2.md` — root cause and correction record.


## v0.5.3.3 exact-trace correction utilities

- `EXACT_TRACE_DEBUG_REPORT_S2_2_V0_5_3_3.md` — sample-by-sample diagnosis from the actual MATLAB seed-7 trial.
- `SEED7_EXACT_TRACE_REPLAY_V0_5_3_3.json` — extracted evidence and exact ground-dynamics replay metrics.
- `s2_2_v0_5_3_3_touchdown_replay_regression.py` — source and exact-trace replay checks.
- `audit_S2_2_v0_5_3_3.py` — cumulative package audit.
