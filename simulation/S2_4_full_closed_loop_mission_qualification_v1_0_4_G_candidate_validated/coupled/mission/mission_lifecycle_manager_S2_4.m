function [log,summary,maps] = mission_lifecycle_manager_S2_4(cfg,scenario)
% MISSION_LIFECYCLE_MANAGER_S2_4 Coupled active-exploration candidate.
%
...
if lastMapUpdate.accepted
    ...
    initialRecord=struct('packet',perceptionPacket, ...
...
for k=2:maxSteps
    ...
    if lastMapUpdate.accepted
        ...
        sidecarRecord=struct('packet',perceptionPacket, ...
    ...
    if executionSafetyEnabled&&explorationActive&&strcmp(state,'TRACK_OUTBOUND')&& ...
        ...
        if executionStatus.valid
            ...
            pendingExplorationTerminal=executionAuthorityInvalidationCount>= ...
    ...
    if pendingReplan&&pendingExplorationReplan&& ...
        ...
        pendingReplan=false;pendingExplorationReplan=false;pendingFallbackPath=zeros(0,2);
        gridFallbackActive=false;goalUnreachable=true;state='GOAL_UNREACHABLE';
