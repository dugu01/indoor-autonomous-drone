...
% PLOT_S2_2_DASHBOARD Stage S2.2 v0.4 tabbed 6-DOF dashboard.
...
title(tl,sprintf('Stage S2.2 %s — estimator-in-the-loop 6-DOF replanning — %s', ...
...
handles=[hTruth hEst hRef hStart hGoal];names={'Truth','Selected ESKF','Controller reference','Start','Goal'};
...
legend(ax,{'Thrust [N]','|Moment| [N m]','XY speed [m/s]','XY accel [m/s^2]'},'Location','best');
