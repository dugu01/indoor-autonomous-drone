...
def run_case(name,cfg,nominal_trace=None):
    ...
    expectations={
      ...
      'dead_end_recovery':('safe_discovery_or_replan',True),
      ...
      'dynamic_to_static_mapping':('promotion_required_replan_conditional',True),
    }
...
def main():
    ...
    source_contracts={
      ...
      'dead_end_replan_conditional': "scenario.name='DEAD_END_RECOVERY'" in scenario_text and "scenario.expectedMapReplan=false;" in scenario_text.split("scenario.name='DEAD_END_RECOVERY'",1)[1].split("case {'goal_requires_scan'",1)[0],
      'dynamic_promotion_replan_conditional': "scenario.name='DYNAMIC_TO_STATIC_MAPPING'" in scenario_text and "scenario.expectedMapReplan=false;" in scenario_text.split("scenario.name='DYNAMIC_TO_STATIC_MAPPING'",1)[1].split("case {'rtl_obstacle_online'",1)[0],
    }
