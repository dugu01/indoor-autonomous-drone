...
def source_contracts():
    ...
    ck('candidate_version_v1_0_5','v1.0.5-estimation-perception-robustness-candidate' in c)
...
def main():
    ...
    print(f'\nS2.5 v1.0.5 INHERITED RECOVERY REGRESSION BACKTEST: {"PASS" if ok else "FAIL"}')
