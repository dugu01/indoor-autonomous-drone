...
def source_contracts():
    ...
    ck('candidate_version_v1_0_9','v1.0.9-estimation-perception-robustness-candidate' in c)
...
def main():
    ...
    print(f'\nS2.5 v1.0.9 INHERITED RECOVERY REGRESSION BACKTEST: {"PASS" if ok else "FAIL"}')
