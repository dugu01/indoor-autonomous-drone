...
# A. Autonomy core identity: reviewed v1.0.4 r1 wiring-hotfix runtime.
# Delta from delivered v1.0.4 is exactly the recovery-config call-site dereference.
expected_manager='507e6e1ede1880ef571f03562555f717f52ea6ec90606f3ddf38186a12c6b401'
ck('v104_mission_manager_byte_identity',sha(manager)==expected_manager,sha(manager))
...
def main():
    ...
    print(f'\nS2.5 PARALLEL HARNESS PYTHON BACKTEST: {"PASS" if passed else "FAIL"}')
