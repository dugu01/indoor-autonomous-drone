...
**Right now:** developing and qualifying S2.5 (estimator + perception fault
robustness) on top of the validated S2.4-G baseline. **Next:** freeze S2.5, then
S3 (dynamic obstacles) and S4 (marker landing), then hardware bring-up on
ROS 2 / PX4.
