#!/usr/bin/env python3
"""Cumulative source/package audit for Stage S2.2 v0.5.3.1.
...
required=[
 ...
 's2_2_v0_5_3_1_multiseed_regression.py','s2_2_v0_5_3_1_xy_loss_regression.py','MULTISEED_MECHANISM_REGRESSION_S2_2_V0_5_3.txt']
...
add('v0.5.3.1 result namespace',"cfg.version='v0.5.3.1';" in cfg and "'S2_2_mission_replanning',versionFolder" in runm)
...
add('XY brake-before-descent gate',all(x in life for x in ['horizontalBrakeComplete','xyLossBrakeExitSpeed_mps','xyLossBrakeReleaseSpeed_mps']))
add('confidence-limited velocity damping',"'horizontalVelocityDampingEnabled',dampingEnabled" in life and 'xy_loss_horizontal_command' in life)
add('level blind descent',"'horizontalFeedforwardAccelEnabled',false" in life)
...
focus_ok,focus_tail=run('s2_2_v0_5_3_1_multiseed_regression.py')
...
print('CUMULATIVE S2.2 v0.5.3.1 AUDIT: PASS')
