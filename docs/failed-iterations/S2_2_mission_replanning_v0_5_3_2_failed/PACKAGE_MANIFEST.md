# Package Manifest — Stage S2.2 v0.5.3.2 Multi-Seed Robustness Candidate
...
## v0.5.3.2 correction utilities

- `audit_S2_2_v0_5_3_2.py` — cumulative source/package audit.
- `s2_2_v0_5_3_2_xy_loss_regression.py` — focused blind-mode braking regression.
