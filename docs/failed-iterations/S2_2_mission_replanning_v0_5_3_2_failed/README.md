# Stage S2.2 v0.5.3.2 — Multi-Seed Robust Autonomous Replanning Candidate
...
Use only these v0.5.3.2 acceptance entry points:

- `audit_S2_2_v0_5_3_2.py`
...
```bash
python3 audit_S2_2_v0_5_3_2.py
python3 s2_2_v0_5_3_2_xy_loss_regression.py
```
...
`simulation/results/S2_2_mission_replanning/v0_5_3_2/`
