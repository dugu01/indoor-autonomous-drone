...
% last aid-bounded horizontal velocity with a frozen open-loop impulse,
% then descend after the commanded acceleration has jerk-settled. No stale
% XY position or post-loss inertial velocity is used.
cfg.emergencyVelocityDampingEnabled=false;
...
cfg.xyLossBrakeSettleTime_s=0.16;
