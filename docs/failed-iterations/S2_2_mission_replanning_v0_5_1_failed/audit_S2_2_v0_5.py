...
add('versioned result path',"cfg.version='v0.5.1';" in cfg and "'S2_2_mission_replanning',versionFolder" in run)
try:
...
add('versioned v0.5.1 output conventions','versionFolder' in run and "cfg.version='v0.5.1';" in cfg)
