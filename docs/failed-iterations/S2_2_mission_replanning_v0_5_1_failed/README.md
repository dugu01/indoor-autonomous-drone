# Stage S2.2 v0.5.1 — Runtime-Corrected Autonomous Mission Lifecycle Candidate
...
Results are stored under `simulation/results/S2_2_mission_replanning/v0_5_1/`.
...
```text
PREFLIGHT_REJECT
EMERGENCY_HOLD → EMERGENCY_LAND → DISARM
